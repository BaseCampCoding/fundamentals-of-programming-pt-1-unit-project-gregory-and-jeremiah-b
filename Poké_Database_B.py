...
while True:
    Answer=input("What do you want to search by? names, types, weaknesses, generations (exit to quit)\n")
    if Answer == "names":
        while True:
        ...
        while True:
            ...
            for i in Data.Starters:
                if i[3] == generations:
                    ...
                    print("Not a proper Generation. Please choose valid Generation")
    elif Answer == "exit":
        break